...
once the sun rises and heats up the sand, you might be able to use the glider and the hot air 
...
Note that this sequence has one fewer value than the input sequence because at each step it considers 
