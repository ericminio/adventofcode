...
const { init, gps, nextGeneration, firstPath } = require('./gps');
...
describe('gps', () => {
    ...
    it('offers a stop-at-first-match', () => {
        let map = load(`
            00
            10
        `);
        ...
        let { path, heads } = firstPath(request, map);
        ...
        expect(Object.keys(heads)).to.deep.equal([ '1x1', '0x0' ]);
    });
