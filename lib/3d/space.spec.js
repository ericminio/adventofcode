...
describe.only('space', () => {
    ...
    it('computes 3 neighbours as expected', () => {
    ...
    it('computes 5 neighbours as expected', () => {
        expect(map['1x0x0']).to.deep.equal({
            id: '1x0x0',
            position: { x: 1, y: 0, z: 0 },
            neighbours: [ '2x0x0', '0x0x0', '1x1x0', '1x0x1' ]
        });
    });

    it('computes 6 neighbours as expected', () => {
