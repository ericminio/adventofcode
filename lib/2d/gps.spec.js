...
const search = (target, map, heads) => {
    ...
    return search(target, map, nextGeneration(heads, map, target));
};

const nextGeneration = (heads, map, target) => {
    let nextHeads = {};
