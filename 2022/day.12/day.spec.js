...
const { load, solve1, solve2 } = require('./solve');
...
describe('2022.12', () => {
    ...
    describe('part 1', () => {
        ...
        it('is solved', () => {
            expect(solve1(`${__dirname}/data/input.txt`)).to.equal(517);
        });
    ...
    describe('part 2', () => {
        ...
        it('has an example', () => {
            expect(solve2(`${__dirname}/data/example.txt`)).to.equal(29);
        });
        it('is solved', () => {
            expect(solve2(`${__dirname}/data/input.txt`)).to.equal(512);
        });
